...
def creation_compte(request):
    ...
    context["titresite"]=TITRE_SITE
    return render(request,'utilisateurs/creation_compte.html',context)
...
def validation_compte(request,login=None,lehash=None):
    ...
    context["titresite"]=TITRE_SITE
    return render(request,'utilisateurs/validation_compte.html',context)
...
def recuperation_password(request):
    ...
    return render(request,'utilisateurs/recuperation_password.html',context)
...
def demande_reinitialisation(request,login=None,lehash=None):
    ...
    context["titresite"]=TITRE_SITE
    return render(request,'utilisateurs/demande_reinitialisation.html',context)
                ...
                if not utilisateur.en_attente_confirmation:
                    if utilisateur.doit_changer_mdp:
                        if passwordnew==passwordconfirm and passwordnew!=password:
                            ...
                            return render(request,'utilisateurs/change_mdp.html',context)
            except:
                pass
    return render(request,'utilisateurs/change_mdp.html',context)
